...
**
** Created: Mon 26. Aug 10:42:37 2019
...
static const uint qt_meta_data_QCPGraphCurve[] = {
...
static const char qt_meta_stringdata_QCPGraphCurve[] = {
    "QCPGraphCurve\0"
};

const QMetaObject QCPGraphCurve::staticMetaObject = {
    { &QCPAbstractPlottable::staticMetaObject, qt_meta_stringdata_QCPGraphCurve,
      qt_meta_data_QCPGraphCurve, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QCPGraphCurve::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *QCPGraphCurve::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *QCPGraphCurve::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QCPGraphCurve))
        return static_cast<void*>(const_cast< QCPGraphCurve*>(this));
    return QCPAbstractPlottable::qt_metacast(_clname);
}

int QCPGraphCurve::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QCPAbstractPlottable::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
