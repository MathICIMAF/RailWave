...
public:
    ...
    EigenData(double px, double py, int prow, int pcol, int ptype, QString pname)
    {
        x = px;
        y = py;
        row = prow;
...
/////////////////////  Graph Curve /////////////////////
////////////////////////////////////////////////////////
class QCP_LIB_DECL QCPGraphCurve : public QCPAbstractPlottable
{
  Q_OBJECT
public:
  /*!
  ...
  */
  ...
  explicit QCPGraphCurve(QCPAxis *keyAxis, QCPAxis *valueAxis);
  virtual ~QCPGraphCurve();

  // getters:
  const QList<EigenData> *data() const { return mData; }
  QCP::ScatterStyle scatterStyle() const { return mScatterStyle; }
  double scatterSize() const { return mScatterSize; }
  QPixmap scatterPixmap() const { return mScatterPixmap; }
  LineStyle lineStyle() const { return mLineStyle; }
  ...
  // setters:
  //void setData(QList<EigenData> *data, bool copy=false);
  void setData(const QVector<EigenData> &value);
  //void setData(const QVector<double> &key, const QVector<double> &value);
  ...
  void addData(const EigenData &value);
  //void addData(double key, double value);
